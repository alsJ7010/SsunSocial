...
function countUser() {
	$.ajax({
		url:'http://localhost:8080/ssun/getUserNum',
		method:'POST',
		processData:false,
		contentType:false,
...
function countPost() {
	$.ajax({
		url:'http://localhost:8080/ssun/countPost',
		method:'POST',
		processData:false,
...
function countTodaysPost() {
	$.ajax({
		url:'http://localhost:8080/ssun/countTodaysPost',
		method:'POST',
		processData:false,
		contentType:false,
		success:function(data){
...
function countTodaysComment() {
	$.ajax({
		url:'http://localhost:8080/ssun/countTodaysComment',
		method:'POST',
		processData:false,
		contentType:false,
		success:function(data){
...
function writerTop5() {
	$.ajax({
		url:'http://localhost:8080/ssun/writerTop5',
		method:'POST',
		processData:false,
		contentType:false,
		success:function(data){
...
function c_writerTop5() {
	$.ajax({
		url:'http://localhost:8080/ssun/c_writerTop5',
		method:'POST',
		processData:false,
		contentType:false,
		success:function(data){
...
function postRatio() {
	$.ajax({
		url:'http://localhost:8080/ssun/getPostRatio',
		method:'POST',
		processData:false,
		contentType:false,
		success:function(data){
...
function commentCount_Top5() {
	$.ajax({
		url:'http://localhost:8080/ssun/commentCount_Top5',
		method:'POST',
		processData:false,
		contentType:false,
		success:function(data){
...
function likeCount_Top5() {
	$.ajax({
		url:'http://localhost:8080/ssun/likeCount_Top5',
		method:'POST',
		processData:false,
		contentType:false,
		success:function(data){
...
function likeCommentCount_Top5() {
	$.ajax({
		url:'http://localhost:8080/ssun/likeCommentCount_Top5',
		method:'POST',
		processData:false,
		contentType:false,
		success:function(data){
