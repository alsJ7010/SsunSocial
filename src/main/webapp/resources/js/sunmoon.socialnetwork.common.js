...
function loginCheckProc(data, user_num) {
   ...
   if ( data == "1" ){
      ...
      window.location.href="http://localhost:8080/ssun/newsFeed";
...
function deleteMsg(num){
   ...
   $.ajax({
          url : 'http://localhost:8080/ssun/deleteMsg',
          method : 'POST',
          ...
          success : function(data) {
            ...
            alert("쪽지를 삭제했습니다 :)");
            window.location.href="http://localhost:8080/ssun/Msg";
          },
...
function countMyMsg(){
	...
	$.ajax({
	       url : 'http://localhost:8080/ssun/countMyMsg',
	       method : 'POST',
	       data : JSON.stringify(sendData),
	       processData : false,
	       contentType : 'application/json',
...
function notRead(){
	...
	$.ajax({
	       url : 'http://localhost:8080/ssun/notRead',
	       method : 'POST',
	       data : JSON.stringify(sendData),
	       processData : false,
	       contentType : 'application/json',
...
function receiveList(){
	...
	$.ajax({
	       url : 'http://localhost:8080/ssun/receive',
	       method : 'POST',
	       data : JSON.stringify(sendData),
	       processData : false,
	       contentType : 'application/json',
...
function List(){
	...
	$.ajax({
	       url : 'http://localhost:8080/ssun/msg',
	       method : 'POST',
	       data : JSON.stringify(sendData),
	       processData : false,
	       contentType : 'application/json',
...
function MsgContent(num){
    ...
    $.ajax({
		url : 'http://localhost:8080/ssun/open',
		method : 'POST',
		data : JSON.stringify(sendData),
		processData : false,
		contentType : 'application/json',
...
function send(){
	...
	if (title == "") {
		...
		console.log("값아??" + title + "/" + msg + "/" + from_user_num + "/"
				+ to_user_num);
		$.ajax({
			url : 'http://localhost:8080/ssun/sendMsg',
			method : 'POST',
			data : JSON.stringify(sendData),
			processData : false,
			contentType : 'application/json',
...
function getBusData_p_ca(){
	...
	$.ajax({
	       url : 'http://localhost:8080/ssun/bus_p_ca',
	       method : 'GET',
	       data : name,
	       processData : false,
	       contentType : false,
...
function getBusData_p_ct(){
	...
	$.ajax({
	       url : 'http://localhost:8080/ssun/bus_p_ct',
	       method : 'GET',
	       data : name,
	       processData : false,
	       contentType : false,
...
function getBusData_p_ot(){
	...
	$.ajax({
	       url : 'http://localhost:8080/ssun/bus_p_ot',
	       method : 'GET',
	       data : name,
	       processData : false,
	       contentType : false,
...
function getBusData_p_cc(){
	...
	$.ajax({
	       url : 'http://localhost:8080/ssun/bus_p_cc',
	       method : 'GET',
	       data : name,
	       processData : false,
	       contentType : false,
...
function getBusData_t_ca(){
	...
	$.ajax({
	       url : 'http://localhost:8080/ssun/bus_h_ca',
	       method : 'GET',
	       data : name,
	       processData : false,
	       contentType : false,
...
function getBusData_t_ct(){
	...
	$.ajax({
	       url : 'http://localhost:8080/ssun/bus_h_ct',
	       method : 'GET',
	       data : name,
	       processData : false,
	       contentType : false,
...
function getBusData_i_ca(){
	...
	$.ajax({
	       url : 'http://localhost:8080/ssun/bus_s_ca',
	       method : 'GET',
	       data : name,
	       processData : false,
	       contentType : false,
...
function getBusData_i_ct(){
	...
	$.ajax({
	       url : 'http://localhost:8080/ssun/bus_s_ct',
	       method : 'GET',
	       data : name,
	       processData : false,
	       contentType : false,
