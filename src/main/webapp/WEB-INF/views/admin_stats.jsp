...
<link rel="stylesheet" type="text/css" href="/ssun/resources/css/bootstrap.min.css" />
<link rel="stylesheet" type="text/css" href="/ssun/resources/css/ossn.admin.default.css" />
...
<script src="/ssun/resources/js/jquery.scrolling.js?ossn_cache=4f3a726e"></script>
<script src="/ssun/resources/js/Chart.min.js"></script>
<script src="/ssun/resources/js/chart.legend.js"></script>
<script src="/ssun/resources/js/sunmoon.socialnetwork.administrator.js"></script>
					...
					<ul class="navbar-right">
						<div class="dropdown">
							...
							<ul class="dropdown-menu multi-level" role="menu"
								...
								<li><a href="http://localhost:8080/ssun/newsFeed">메인페이지로 돌아가기</a></li>
								...
								<div class="row">
									<div class="col-md-4 admin-dashboard-item">
										<div class="admin-dashboard-box admin-dashboard-box-small">
											<div class="admin-dashboard-title">SGDG Version</div>
											<div
