...
<script src="/ssun/resources/js/ARf53_7CZrph6eMZGwgXpTF2-tk.js"></script>
										...
										<table class="table ossn-users-list" id="paging" name="paging">
											...
											<tbody>
												<c:forEach var="adminInfo" items="${allUser}">
													...
													<tr>
														<td style="text-align: left;" class="btnBlock">${adminInfo.admin_name}</td>
														<td style="text-align: left;" class="btnBlock">${adminInfo.admin_num}</td>
														<td style="text-align: left;" class="btnBlock">${adminInfo.admin_protal}</td>
														<td style="text-align: left;" class="btnBlock">${adminInfo.admin_dep}</td>

														<td style="text-align: left;" ><a
															href="/ssun/admin/edituser?number=${adminInfo.admin_num}">정보수정</a>
														</td>
