...
<script type="text/javascript"
	src="./ossn_login_files/opensource.socialnetwork.js"></script>
...
<link rel="stylesheet" type="text/css"
	href="./ossn_login_files/jquery-ui.css">
<script>
	...
	function LoginCheck() {
		...
		// 1. Validation Check.
	    var emptyName = document.forms["ossn-login"]["username"].value;
	   ...
	   // 2. Form Data Send
		...
		$.ajax({
			url : 'http://localhost:8080/ssun/login',
			method : 'POST',
			data : formData,
			processData : false,
			contentType : false,
...
/*  			console.log("success data: "+data);
				...
				if(data.user_num == emptyName && data.password == emptyPw){
					if(data.certify == 'y'){
						console.log("===============일치해==============");
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-7 site-name text-center ">
							<span><a href="http://localhost:8080/ssun/">😄 선문대 귀는 당나귀 귀 😄</a></span>
						</div>
														...
														<fieldset>
															...
															<div>
																<label>학번</label> <input type="text"
																	name="username" value="" onkeyup="enterkey();">
															</div>
															...
															<div>
																<div>
																	<div>
																		...
																		<input type="button" id="findPwd" value="비밀번호찾기" class="btn btn-primary" onclick="location.href='http://localhost:8080/ssun/password'">
																		<input type="button" id="Member" value="회원가입" class="btn btn-join" onclick="location.href='http://localhost:8080/ssun/register'">
