...
<link rel="stylesheet" type="text/css"
   ...
   <!-- 20181120 민정추가  -->
 <!-- <script type="text/javascript" src="/ssun/resources/js/sunmoon.socialnetwork.js"></script> -->
...
<div name="ossn-message-box-send-post" id="ossn-message-box-send-post" class="ossn-message-box-edit-post" style="display: none;">
		<div class="title">
		<span id="txt0"></span>
		...
		<div id="line" class="line" style=" padding: 10px;">
			<input class="who" id="who" value="보낸 사람" disabled="disabled" style="font-weight: bold;">
			<span id="txt2">	</span> 

			<span id="txt3">	</span>
			<input class="sendTime" id="sendTime" value="보낸 날짜" disabled="disabled" style="font-weight: bold;" >	
		</div>
...
<!-- ================================================================================ -->
	<div class="ossn-inner-page">
		...
		<ul id="tab" name="tab" class="tab">
			<li class="current" data-tab="tab1"><a id="List_" onclick="javascript:receiveList();">받은 쪽지</a></li>
		 	<li data-tab="tab2"><a id="receiveList_" onclick="javascript:List();">보낸 쪽지</a></li>
		</ul>
		...
		<div id="tab1" class="tabcontent current">
													...
													<div id="receiveMsgList-post-popup">
														...
														<table id="toMsgList" name="toMsgList" class="sendMsgListTable"  style="width: 100%">
															<!-- 쪽지 들어와라~~ -->
		...
		<div id="tab2" class="tabcontent ">
													...
													<div id="sendMsgList-post-popup">
														...
														<table id="fromMsgList" class="sendMsgListTable"  style="width: 100%">
															<!-- 쪽지 들어와라~~ -->
														</table>
