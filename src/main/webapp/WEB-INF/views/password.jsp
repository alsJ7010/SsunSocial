...
<script>
	...
	function findPassword() {
		...
		$.ajax({
			url : 'http://localhost:8080/ssun/findPassword',
			method : 'POST',
			data : formData,
			processData : false,
			contentType : false,
													...
													<form id="mypage_form"
														...
														<fieldset>
															...
															<input type="hidden" name="ossn_token"
																...
																포털 이메일</label>
															<div>
																<input type="text" id="find_portal_emial" name="find_portal_emial"
																	placeholder="ex) haedal2" style="width: 130px;" />
																@sunmoon.ac.kr
															</div>

															<div>
																<label>학번(사번)</label> <input type="text" id="find_user_num"
																	name="find_user_num" placeholder="ex) 2016244025" />
