...
public class AdminStatsDao {
	...
	public String getUserNum() {
		...
		// 인증된 사용자 수 가져오기
		String sqlStatement1 = "select count(*) from userinfo where certify='y'";
		int certifyUser = jdbcTemplate.queryForObject(sqlStatement1, Integer.class);
		data.add(certifyUser);

		// 차단된 사용자 수 가져오기
		String sqlStatement2 = "select count(*) from userinfo where certify='b'";
		int blockUser = jdbcTemplate.queryForObject(sqlStatement2, Integer.class);
		data.add(blockUser);
		
		// 인증되지 않은 사용자 수 가져오기
		String sqlStatement3 = "select count(*) from userinfo where certify is null";
	...
	public List<countTop5> writerTop5() {
		...
		String sqlStatement = "select userinfo.user_name, count(timeline_post.w_content) as cnt from timeline_post, userinfo where not userinfo.department='Admin' and timeline_post.delYN='N' and timeline_post.user_num = userinfo.user_num and timeline_post.anonymity='N' and timeline_post.w_time like '"+date+"%' group by timeline_post.user_num order by cnt desc limit 5";
		...
		return jdbcTemplate.query(sqlStatement, new RowMapper<countTop5>() {
			...
			public countTop5 mapRow(ResultSet rs, int rowNum) throws SQLException {
				...
				data.setContent(rs.getString("user_name"));
	...
	public List<countTop5> c_writerTop5() {
		...
		String sqlStatement = "select userinfo.user_name, count(timeline_comment.c_content) as cnt from timeline_comment, userinfo where not userinfo.department='Admin' and timeline_comment.delYN='N' and timeline_comment.user_num = userinfo.user_num and timeline_comment.c_time like '"
				+ date + "%' group by timeline_comment.user_num order by cnt desc limit 5";
	...
	public List<countTop5> commentCount_Top5() {
		...
		String sqlStatement = "select timeline_post.w_content, timeline_post.comment_num from timeline_post where not timeline_post.comment_num = 0 and timeline_post.delYN='N' and timeline_post.w_time like '"+date+"%' order by timeline_post.comment_num desc limit 5;";
		...
		return jdbcTemplate.query(sqlStatement, new RowMapper<countTop5>() {
			...
			public countTop5 mapRow(ResultSet rs, int rowNum) throws SQLException {
				...
				data.setCount(rs.getInt("comment_num"));
	...
	public List<countTop5> likeCount_Top5() {
		...
		String sqlStatement = "select timeline_post.w_content, timeline_post.like_num from timeline_post where not timeline_post.like_num = 0 and timeline_post.delYN='N' and timeline_post.w_time like '"
				+ date + "%' order by timeline_post.like_num desc limit 5;";
		...
		return jdbcTemplate.query(sqlStatement, new RowMapper<countTop5>() {
			...
			public countTop5 mapRow(ResultSet rs, int rowNum) throws SQLException {
				...
				data.setContent(rs.getString("w_content"));
				data.setCount(rs.getInt("like_num"));
	...
	public List<countTop5> likeCommentCount_Top5() {
		...
		String sqlStatement = "select timeline_comment.c_content, timeline_comment.like_num from timeline_comment where not timeline_comment.like_num = 0 and timeline_comment.delYN='N' and timeline_comment.c_time like '"
				+ date + "%' order by timeline_comment.like_num desc limit 5;";
