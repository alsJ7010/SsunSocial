...
import kr.sunmoon.ssun.service.MainTimelineService;
...
public class MainTimelineController {
	...
	public PostInfo posting(@RequestParam Map<String, Object> post,
	    ...
	    // 글 번호 가져오기
	    int w_num = mainTimelineService.getW_num(w_info.getUser_num(), w_info.getW_date(), w_info.getW_content(), w_info.getDep_code());
	...
	public List<PostView> postList(@RequestBody Map<String, Object> data) {
	...
	public List<PostView> extraPostList(@RequestBody Map<String, Object> data) {
	...
	@ResponseBody
	public SaveCommentInfo writeComment(@RequestBody Map<String, Object> comment
			                /*MultipartHttpServletRequest request*/) throws Exception {
		
		SaveCommentInfo c_info = new SaveCommentInfo();
		
		c_info.setW_num(Integer.parseInt(comment.get("w_num").toString()));
		c_info.setUser_num(Integer.parseInt(comment.get("user_num").toString()));
		...
		// 글 번호 가져오기
	    int c_num = mainTimelineService.getC_num(c_info.getUser_num(), c_info.getC_time(), c_info.getC_content());
	...
	public List<GetCommentInfo> commentList(@RequestBody Map<String, Object> comment) throws Exception {
	...
	public List<PostView> searchPostList(@RequestBody Map<String, Object> data) throws Exception {
	...
	public List<PostView> searchExtraPostList(@RequestBody Map<String, Object> data) {
	...
	public PostInfo postNotice(@RequestParam Map<String, Object> post, MultipartHttpServletRequest request)
		...
		// 글 번호 가져오기
		int w_num = mainTimelineService.getW_num(w_info.getUser_num(), w_info.getW_date(), w_info.getW_content(),
				w_info.getDep_code());
		w_info.setW_num(w_num);
	...
	public List<PostView> noticePostList() throws Exception {
	...
	public List<PostView> bestLikePostInfo() throws Exception {
	...
	public List<PostView> bestCommentPostInfo() throws Exception {
