...
public class MainTimelineService {
	...
	// 처음 글 10개 가져오기
	public List<PostView> getAllWriting(String dep_code) {
		return mainTimelineDao.getPostInfo(dep_code);
	}
	
	// 스크롤 내릴때마다 글 10개씩 더 가져오기
	public List<PostView> getExtraWriting(String dep_code, int calledNum) {
	...
	public int getW_num(int u_num, String w_time, String w_content, String dep_code) {
		return mainTimelineDao.getW_num(u_num, w_time, w_content, dep_code);
	}
	
	public void saveComment(SaveCommentInfo infoData) {
		mainTimelineDao.insertComment(infoData);
	}
	
	public int getC_num(int u_num, String c_time, String c_content) {
		return mainTimelineDao.getC_num(u_num, c_time, c_content);
	}
	...
	public List<PostView> getSearchWriting(String type, String word, String dep_code) {
		return mainTimelineDao.getSearchWriting(type, word, dep_code);
	}
	
	// 스크롤 내릴때마다 검색 글 10개씩 더 가져오기
	public List<PostView> getSearchExtraWriting(int calledNum, String type, String word, String dep_code) {
